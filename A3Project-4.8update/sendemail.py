...
def send_mail(email, name):
    ...
    pwd = "LQRXHAVJWTIOQWYE"
    sender = "wszs20031208@163.com"

    rev = email
    title = 'THANK YOU FOR DONATION'
    cont = "Dear "+name+""",\n I hope this letter finds you well. I wanted to express my sincerest gratitude for your generous donation. Your contribution will make a significant impact on our ability to [state the purpose of the donation].

We believe that every little bit counts, and we are grateful for donors like you who make it possible for us to continue our mission. Your donation will help us [state the specific goals or programs that will benefit from the donation], and we are honored to have your support.
